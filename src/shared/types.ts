...
export interface RenderStats {
  ...
  readonly dirtyLayers: Set<RenderLayer>;
}
...
export interface HeatmapConfig {
  ...
  readonly binIntervalSec: number;
  readonly priceBinSize: number;
  readonly maxNotionalForNormalization: number;
...
export interface HeatmapRenderStats {
  ...
  readonly offscreenBlitUsed: boolean;
}

// ═══════════════════════════════════════════════
// FAZ 2: WALL CLUSTER TYPES
// ═══════════════════════════════════════════════
...
export interface WallDetectorConfig {
  ...
  readonly minDominanceRatio: number;
  readonly persistentThresholdSec: number;
  readonly clusterMergeBps: number;
}

export const DEFAULT_WALL_CONFIG: WallDetectorConfig = {
  maxLevels: 100,
  percentileThreshold: 0.90,
  minDominanceRatio: 0.58,
  persistentThresholdSec: 30,
  clusterMergeBps: 5,
};
